package de.ukhd.medic.mpi.security;
...
public class CustomSocketFactory extends StandardSocketFactory
{
	...
	/**
	 * @param trustCertificatesFile               the path to the PEM encoded file containing the chain of trusted certificates, not <code>null</code>
	 * @param clientCertificateFile               the path to the PEM encoded file containing the client certificate, not <code>null</code>
	 * @param clientCertificatePrivateKeyFile     the path to the PEM encoded file containing the client certificate private-key, not <code>null</code>
	 * @param clientCertificatePrivateKeyPassword if the PEM encoded client certificate private key is encrypted, will be ignored if <code>null</code>
	 */
